...
def test_access_to_bun():
    ...
    WebDriverWait(driver, 10).until(expected_conditions.element_to_be_clickable((By.XPATH, '//span[text()="Булки"]')))

    class1 = driver.find_element(*TestLocators.BUTTON_BUN_CLASS).get_attribute('class')
