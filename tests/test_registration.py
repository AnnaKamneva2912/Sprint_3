...
def test_1_registration():
    ...
    driver.find_element(*TestLocators.FIELD_EMAIL).send_keys("class_class@yandex.ru")
    driver.find_element(*TestLocators.FIELD_PASSWORD_REGISTRATION).send_keys("1234A!")
